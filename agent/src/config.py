...
# =============================================================================
# Zep Ontology Schema - Entity and Edge Type Definitions
# =============================================================================

# Default entity types for the knowledge graph
# These are the node types that Zep will extract from conversations
DEFAULT_ENTITY_TYPES: list[dict] = [
    # Zep built-in types (always present)
    {
        "name": "Preference",
        "description": "User preferences, choices, opinions, or selections. Examples: 'I prefer window seats', 'I like spicy food', 'My favorite color is blue'."
    },
    {
        "name": "Procedure", 
        "description": "Multi-step instructions, workflows, or processes the agent should follow."
    },
    # Common entity types
    {
        "name": "Person",
        "description": "A human being mentioned in conversation. Can be family, friends, colleagues, or public figures."
    },
    {
        "name": "Organization",
        "description": "Companies, institutions, teams, or groups. Examples: employers, schools, clubs."
    },
    {
        "name": "Location",
        "description": "Physical places including cities, countries, addresses, venues, or geographic regions."
    },
    {
        "name": "Event",
        "description": "Scheduled or past events, meetings, appointments, conferences, or occasions."
    },
    {
        "name": "Project",
        "description": "Work projects, personal initiatives, creative endeavors, or ongoing efforts."
    },
    {
        "name": "Topic",
        "description": "Subjects of interest, areas of knowledge, or discussion themes."
    },
    {
        "name": "Product",
...
# Default edge types for relationships between entities
DEFAULT_EDGE_TYPES: list[dict] = [
    ...
    {
        "name": "LIVES_IN",
        "description": "The user's residence or location."
    },
    {
        "name": "INTERESTED_IN",
    ...
    {
        "name": "ATTENDED",
        "description": "Events the user has attended or will attend."
    },
    {
        "name": "USES",
    ...
    {
        "name": "PREFERS",
        "description": "Preferences the user has expressed."
    },
]
